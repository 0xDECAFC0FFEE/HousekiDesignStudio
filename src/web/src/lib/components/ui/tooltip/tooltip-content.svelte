<script>
	// Local edit to the CLI's file: z-[100] below, not z-50, so a tooltip shows in front of a colour
	// picker popover (z-50) that opened before it.
